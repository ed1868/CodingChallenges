...
// function crack(hash){
//   console.log("epa")
//   const convert2md5 = require('crypto');
//   for (let i = 0; i < 100000; i++) {
//     let variable = i.toString();
   
//     while (variable.length < 5) 
//       variable = "0"+variable;
//     if (hash === convert2md5.createHash('md5').update(variable).digest("hex"))
//       return variable;
//   }
// }
...
//     const testHash = crypto.createHash('md5').update(pin).digest('hex');
//     if (testHash === hash) return pin;
//   }
// }
...
// crack('1D10E7644AFA3F388300B4BD49E7863E')
